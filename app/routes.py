...
from app.utils import get_b64encoded_qr_image, get_gemeente, get_gemeente_by_id, get_gemeente_by_name, get_mysql_match_against_safe_string, purge_nginx_caches, remove_id
        ...
        if custom_form_validate_on_submit(publish_form):
            if publish_form.submit.data:
                ...
                for election in [x.verkiezing for x in elections]:
                    ...
                    purge_nginx_caches(gemeente, temp_gemeente_draft_records, current_app.logger)
