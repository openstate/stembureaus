...
def main():
    ...
    # 2023TK
    with open('files/6259e07d-7017-4d28-b3e2-cf4403b13d5f.csv') as IN:
            ...
            for key, value in data.items():
                if key in old_fieldnames:
                    ...
                    # Change openingstijd
                        ...
                        record['Openingstijd'] = re.sub('20..-..-..', '2024-06-06', value)
                        continue
                    # Change sluitingstijd
                    elif key == 'Sluitingstijd':
                        record['Sluitingstijd'] = re.sub('20..-..-..', '2024-06-06', value)
                        continue
                    else:
                        record[key] = value
