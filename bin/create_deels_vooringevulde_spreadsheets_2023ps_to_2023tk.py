...
def main():
    ...
    # 2023PS (Europees Nederland)
    with open('files/c02f18b5-994c-4022-b0e5-2b811f918a66.csv') as IN:
    # 2023ER (Caribisch Nederland)
    #with open('files/d3eaa2b2-2958-476e-af2d-c279e0ca6c43.csv') as IN:
        ...
        for row in reader:
            ...
            for key, value in data.items():
                if key in old_fieldnames:
                    ...
                    if key == 'Akoestiek':
                        record['Akoestiek geschikt voor slechthorenden'] = value
                        continue
                    # Change openingstijd
                    elif key == 'Openingstijd':
                        record['Openingstijd'] = re.sub('20..-..-..', '2023-11-22', value)
                        continue
                    # Change sluitingstijd
                    elif key == 'Sluitingstijd':
                        record['Sluitingstijd'] = re.sub('20..-..-..', '2023-11-22', value)
                        continue
                    else:
                        record[key] = value
